...
export const Testimonial: Block = {
  ...
  fields: [
    ...
    },
    {
      name: 'centerCards',
      type: 'checkbox',
      label: 'Center Cards on Screen',
      defaultValue: true,
      admin: {
        description: 'Center the testimonial cards horizontally when there is extra space',
        condition: (_, siblingData) => siblingData.variant === 'horizontal',
      },
    },
  ],
  labels: {
